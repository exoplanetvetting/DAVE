function [ Tlpp, Y, binnedFlux ] = calcLPPMetricLCarray(time,flux,period,duration,phase,mapStructFile )
...
dataStruct.flux=flux;
dataStruct.duration=duration;
dataStruct.period=period;
dataStruct.phase=phase;
