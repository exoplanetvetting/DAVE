function [ dymean, dxmean,dxstd, dxmax ] = knnDistance_inclass( x,y,knn )
%x is a n x ndim  matrix of those objects known to be of the same class
%   y are  n2 x ndim matrix of those objects wanting to be classified
...
%Figure to help udnerstand population
%figure;
%hist(dxmean,60);
