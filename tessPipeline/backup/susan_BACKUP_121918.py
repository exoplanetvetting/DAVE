...
def createConfig(sector, tic, planetNum, debugMode=True):
    ...
    cfg['taskList'] = ['serveTask', 'modshiftTask', 'sweetTask', 'lppMetricTask']
...
#    if ('rv' not in clip.keys()):
#        clip['rv'] = 'No Disposition Determined'
#        clip.rv.isCandidate = 0
#        clip.rv.isSignificantEvent = 0
